...
class TestGptprotoGateway(unittest.TestCase):
    ...
    def test_cloudflare_html_is_not_shown_as_invalid_key(self):
        msg = _friendly_error(
            403,
            "<html><title>Access denied | gptproto.com used Cloudflare</title></html>",
        )
